...
For variant glyphs and features supported in Annapurna, see [Font Features](features).
...
Please send us your requests using the [form on the font website](https://software.sil.org/annapurna/about/contact/). If you are interested in helping us make the fonts better, see the [Developer](developer) page.
